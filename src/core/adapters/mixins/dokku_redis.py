...
class DokkuRedisMixin:
    ...
    def delete_redis(self, service_name: str) -> bool:
    ...
    def import_redis(self, service_name: str, input_file: str) -> bool:
